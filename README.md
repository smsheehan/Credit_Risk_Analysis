...
* Naive Random Oversampling has a balanced accuracy of 62.9%, a precision of 1 percent for high_risk loans, and a recall of 57% for high_risk loans. High_risk f1 is .02
* SMOTE Oversampling has a balanced accuracy of 62.8%, a precision of 1 percent for high_risk loans, and a recall of 62% for high_risk loans. High_risk f1 is .02
* Undersampling with Cluster Centroids algorithm has a balanced accuracy of 53%, a precision of 1 percent for high_risk loans, and a recall of 61% for high_risk loans. High_risk f1 is .01
* Combination over and under sampling with SMOTEENN has a balanced accuracy of 64.1%, a precision of 1 percent for high_risk loans, and a recall of 70% for high_risk loans. High_risk f1 is .02
* Balanced Random Forest Classifier has a balanced accuracy of 78.8%, a precision of 4 percent for high_risk loans, and a recall of 67% for high_risk loans. High_risk f1 is .07
* Easy Ensemble AdaBoost Classifier has a balanced accuracy of 92.5%, a precision of 7 percent for high_risk loans, and a recall of 91% for high_risk loans. High_risk f1 is .14
